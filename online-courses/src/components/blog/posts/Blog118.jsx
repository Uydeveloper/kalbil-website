        ...
        <div className="p-8" style={{ direction: 'rtl', fontFamily: "'UKIJ Tuz', 'UKIJ Nasq', 'Microsoft Uighur', sans-serif" }}>
          ...
          <div className="flex justify-end mb-8 space-x-3 space-x-reverse">
            <button 
              ...
              onClick={() => window.open(`https://wa.me/?text=${encodeURIComponent('AI ئېيجېنتلار ۋە تولغۇرۇشچان AI نى سېلىشتۇرۇش: تولۇق تەپسىلاتلار بىلەن تونۇشۇڭ')}`, '_blank')}
            >
            ...
            <button 
              ...
              onClick={() => window.open(`https://t.me/share/url?url=${encodeURIComponent(window.location.href)}&text=${encodeURIComponent('AI ئېيجېنتلار ۋە تولغۇرۇشچان AI نى سېلىشتۇرۇش')}`, '_blank')}
            >
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 ml-2" viewBox="0 0 24 24" fill="currentColor">
