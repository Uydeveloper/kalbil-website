...
export const courseTopics = [
  ...
  {
    id: "quantum_physics",
    title: "Quantum Physics — Fundamentals (Beginner → Intermediate)",
    slides: [
  ...
  /* ---------------------- Quantum Mechanics (Advanced concepts) ---------------------- */
  {
    ...
    title: "Quantum Mechanics — Deeper (Intermediate)",
    slides: [
  ...
  /* ---------------------- Quantum Technology ---------------------- */
  {
    ...
    title: "Quantum Technology & Devices",
    slides: [
...
df.groupBy('category').count().show()` },
  ...
  {
    id: "git_expanded",
    title: "Git & GitHub — From Basics to Best Practices",
    slides: [
